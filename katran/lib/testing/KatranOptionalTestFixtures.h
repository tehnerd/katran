...
const TestFixture inputOptionalTestFixtures = {
  ...
  //13
  {
    //Ether(src="0x1", dst="0x2")/IP(src="192.168.1.1", dst="172.16.0.123")/UDP(sport=31337, dport=80)/("katran test pkt")
    "AgAAAAAAAQAAAAAACABFAAArAAEAAEARDI3AqAEBrBAAe3ppAFAAF/cba2F0cmFuIHRlc3QgcGt0",
    "network vips ipv4. LPM_VIP_LOOKUP is required"
  },
  //14
  {
    //Ether(src="0x1", dst="0x2")/IPv6(src="fc00:2::1", dst="fc00:2307::2307")/TCP(sport=31337, dport=80,flags="A")/("katran test pkt")
    "AgAAAAAAAQAAAAAAht1gAAAAACMGQPwAAAIAAAAAAAAAAAAAAAH8ACMHAAAAAAAAAAAAACMHemkAUAAAAAAAAAAAUBAgALdDAABrYXRyYW4gdGVzdCBwa3Q=",
    "network vips ipv6. LPM_VIP_LOOKUP is required"
  },
...
const TestFixture outputOptionalTestFixtures = {
  ...
  //11
  {
    "AADerb6vAgAAAAAACABFAAA//AAAAEAEYC+sEGh5CgAAAkUAACsAAQAAQBGtTcCoAQMKyAEBemkAUAAXl9xrYXRyYW4gdGVzdCBwa3Q=",
    "XDP_TX"
  },
  //12
  {
    "AADerb6vAgAAAAAAht1gAAAAAEspQAEAAAAAAAAAAAAAAHppAAL8AAAAAAAAAAAAAAAAAAABYAAAAAAjBkD8ACMHAAEAAAAAAAAAAAAC/AAAAQAAAAAAAAAAAAAAAXppAFAAAAAAAAAAAFAQIADaSAAAa2F0cmFuIHRlc3QgcGt0",
    "XDP_TX"
  },
  //13
  {
    "AADerb6vAgAAAAAACABFAAA/AAAAAEAEXC2sEGh7CgAAA0UAACsAAQAAQBEMjcCoAQGsEAB7emkAUAAX9xtrYXRyYW4gdGVzdCBwa3Q=",
    "XDP_TX"
  },
  //14
  {
    "AADerb6vAgAAAAAAht1gAAAAAEspQAEAAAAAAAAAAAAAAHppAAH8AAEAAAAAAAAAAAAAAAABYAAAAAAjBkD8AAACAAAAAAAAAAAAAAAB/AAjBwAAAAAAAAAAAAAjB3ppAFAAAAAAAAAAAFAQIAC3QwAAa2F0cmFuIHRlc3QgcGt0",
    "XDP_TX"
  },
};
